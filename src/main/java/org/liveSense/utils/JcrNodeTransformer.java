...
public class JcrNodeTransformer {
	...
	public static Node transformHashmapToNode(Node node, HashMap values, Class beanClass, String[]skippedFields) throws InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, ValueFormatException, VersionException, LockException, ConstraintViolationException, RepositoryException {
